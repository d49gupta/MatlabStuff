...
typedef RT_MODEL_cart_trial_simple_15_T RT_MODEL;

/*====================*
 * External functions *
 *====================*/
EXTERN RT_MODEL * cart_trial_simple_15(void);
  ...
  _do_assertion(const char * expression, const char * file_name, int line_number)
{
  ...
  rtmSetErrorStatus(cart_trial_simple_15_M, GBLbuf.message);
}
  ...
  main(int argc, char * argv[])
{
  ...
  if (parseError) {
    (void) fprintf(stderr,
                   "\nUsage: cart_trial_simple_15 -option1 val1 -option2 val2 -option3 ...\n\n");
    (void) fprintf(stderr,
