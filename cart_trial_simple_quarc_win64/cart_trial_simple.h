...
typedef struct {
  ...
  real_T CableGain;                    /* '<S2>/Cable Gain' */
...
struct P_cart_trial_simple_T_ {
  ...
  real_T InverseModulus1_Modulus;      /* Expression: modulus
                                        ...
                                        */
  real_T SignalGenerator2_Amplitude;   /* Expression: 1.5
                                        * Referenced by: '<Root>/Signal Generator2'
                                        */
  real_T SignalGenerator2_Frequency;   /* Expression: 1
                                        * Referenced by: '<Root>/Signal Generator2'
                                        */
 ...
 * '<S1>'   : 'cart_trial_simple/Filtered Derivative (Discrete or Continuous)'
 * '<S2>'   : 'cart_trial_simple/Quarc_Plant2'
 * '<S3>'   : 'cart_trial_simple/Filtered Derivative (Discrete or Continuous)/Enable//disable time constant'
 * '<S4>'   : 'cart_trial_simple/Filtered Derivative (Discrete or Continuous)/Initialization'
 * '<S5>'   : 'cart_trial_simple/Filtered Derivative (Discrete or Continuous)/Integrator (Discrete or Continuous)'
 * '<S6>'   : 'cart_trial_simple/Filtered Derivative (Discrete or Continuous)/Initialization/Init_u'
 * '<S7>'   : 'cart_trial_simple/Filtered Derivative (Discrete or Continuous)/Integrator (Discrete or Continuous)/Discrete'
 */
